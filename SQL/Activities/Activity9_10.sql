...
SELECT SUM(purchase_amount) total from orders GROUP BY purchase_amount;

SELECT SUM(purchase_amount) as "total sum" from orders;

SELECT SUM(purchase_amount) as "Total sum" from orders;

SELECT AVG(purchase_amount) as "Avg sum" from orders;
...
SELECT customer_id, MAX(purchase_amount) as "Highest"   
FROM orders  
ORDER BY customer_id;
...
SELECT salesman_id, MAX(purchase_amount) as "Highest on Date 17/08"  
FROM orders  
WHERE order_date=TO_DATE('2012-08-17', 'YYYY-MM-DD')  
GROUP BY salesman_id, order_date;

SELECT salesman_id as Salesman ID, MAX(purchase_amount) as "Highest on Date 17/08"  
FROM orders  
WHERE order_date=TO_DATE('2012-08-17', 'YYYY-MM-DD')  
GROUP BY salesman_id, order_date;
...
SELECT salesman_id as SID, MAX(purchase_amount) as "Highest on Date 17/08"  
FROM orders  
WHERE order_date=TO_DATE('2012-08-17', 'YYYY-MM-DD')  
GROUP BY salesman_id, order_date;
